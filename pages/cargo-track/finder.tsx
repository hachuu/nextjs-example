...
import { UnTrackingBLSearch } from './components/untracking-BL-search';
...
`;
  ...
  const BLResultDiv = styled.div`
    ...
    margin: 30px 50px;
    display: flex;
    flex-flow: ${(props: { activeDetaillDiv: boolean }) =>
      props.activeDetaillDiv ? "column wrap;" : "none"};
    @media (max-width: 768px) {
      margin: 0 10px 0 10px;
      overflow-y: scroll;
    }
  ...
  const BLListDiv = styled.div`
    flex: ${(props: { activeDetaillDiv: boolean }) =>
      props.activeDetaillDiv ? "0 0 40%" : "1"};
    // flex-basis: ${(props: { activeDetaillDiv: boolean }) =>
      props.activeDetaillDiv ? "100%" : "none"};
    // @media (max-width: 768px) {
    //   overflow-y: scroll;
    // }
  `;
  ...
  return (
    <FinderPageDiv>
      ...
      <PageContent>
              ...
              <BLListDiv activeDetaillDiv={activeDetaillDiv}>
                ...
                <ListTableDiv>
                  ...
                  <TableBodyDiv>
                      ...
                      <TableBodyListDetailDiv>
                        <BLListDetailDiv>
                          ...
                          <BLDetaiTableslDiv>
                            <BLDetailTableDiv>
                              <ListTableDiv>
                                <TableHeadDiv  type={'detail'}>
                                  <TableHeadItemDiv flexValue={0.7}>
                                    ID
                                  </TableHeadItemDiv>
                    ...
                    {activeDetaillDiv && (
                      <TableBodyListDetailDiv>테스트</TableBodyListDetailDiv>
                    )}
                    <TableBodyListDiv>
                      <TableBodyListItemDiv flexValue={0.2}>
                        <input type={"checkbox"}></input>
        ...
        {
          !trackingYactive && (
            <UnTrackingBLSearch></UnTrackingBLSearch>
          )
        }
      </PageContent>
    </FinderPageDiv>
